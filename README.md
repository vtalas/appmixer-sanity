...
| `/authub`                          | Auth Hub — browse and manage OAuth connector configs/bundles in the **production or QA** Auth Hub (switcher), verification status per environment, and upload bundles packed straight from GitHub (`appmixer pack` rules, from appmixer-connectors `dev` or appmixer-components `master`)                                                                  |
