...
import { deleteFlow, getInstanceUrl } from '$lib/api/appmixer.js';
import { markFlowUndeployed } from '$lib/db/e2e.js';
  ...
  try {
    ...
    for (const flowId of flowIds) {
      try {
        ...
        await markFlowUndeployed(await getInstanceUrl(userId), flowId);
